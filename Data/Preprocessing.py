...
pyRAPL.setup()
meter = pyRAPL.Measurement('Preprocess_Adult')
meter.begin()
...
meter.end()
meter.export('Preprocess_Adult.csv')
...
meter = pyRAPL.Measurement('Preprocess_Student')
meter.begin()
...
meter.end()
meter.export('Preprocess_Student.csv')